  ...
  return (
    ...
    >
      <button
        ...
        className="h-11 w-11 rounded-full text-secondary-foreground/80 disabled:opacity-30 disabled:cursor-not-allowed hover:text-primary transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60"
      >
      ...
      <button
        ...
        className="h-[clamp(48px,8vh,68px)] w-[clamp(48px,8vh,68px)] rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-[0_12px_30px_-12px_hsl(var(--gold)/0.9)] hover:brightness-110 active:scale-95 transition disabled:opacity-40 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2"
      >
        {loading ? (
      ...
      <button
        ...
        className={`h-11 w-11 rounded-full transition active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/60 ${
